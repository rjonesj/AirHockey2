...
public class Box2DTest extends GdxTest implements InputProcessor {
    ...
    public void create () {
        ...
        font = new BitmapFont(Gdx.files.internal("libgdx/arial-15.fnt"), false);
        font.setColor(Color.RED);
        textureRegion = new TextureRegion(new Texture(Gdx.files.internal("libgdx/badlogicsmall.jpg")));
    ...
    private void createPhysicsWorld () {
        ...
        // next we create the puckBody for the ground platform. It's
        // simply a static puckBody.
        BodyDef groundBodyDef = new BodyDef();
        groundBodyDef.type = BodyType.StaticBody;
        groundBody = world.createBody(groundBodyDef);

        // finally we add a fixture to the puckBody using the polygon
...
// System.out.println("post solve, normal impulses: " + ni[0] + ", " + ni[1] + ", tangent impulses: " + ti[0] + ", " + ti[1]);
    ...
    private void createBoxes () {
        ...
        // puckBody. First we create a nice polygon representing a box 2 meters
        // wide and high.
        ...
        // puckBody. Note that we reuse the polygon for each puckBody fixture.
        for (int i = 0; i < 20; i++) {
            // Create the BodyDef, set a random position above the
            // ground and create a new puckBody
    ...
    public void render () {
        ...
        // next we render the ground puckBody
    ...
    QueryCallback callback = new QueryCallback() {
        ...
        public boolean reportFixture (Fixture fixture) {
            // if the hit fixture's puckBody is the ground puckBody
            // we ignore it
            if (fixture.getBody() == groundBody) return true;

            // if the hit point is inside the fixture of the puckBody
            // we report it
